...
public class CatMouseSimulation {
    ...
    public static void main(String[] args) {
        ...
        myCat = new Cat(new Position(300.0, 0.0));
        myMouse = new Mouse(new Position(100.0, 0.0));
    ...
    private class MyResetListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            myMouse.setPosition(new Position (100.0, 0.0));
            times = 0;
            status = Status.Init;
    ...
    private class MyStepListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (status == Status.Init|| status == Status.Running) {
                ...
                boolean iseaten=myCat.move(myMouse.getPosition());
                if (!iseaten){
                	 myMouse.move();
                     status = Status.Running;
                     times ++;
    ...
    class MyDrawPanel extends JPanel {
        ...
        public void paintComponent(Graphics graphics) {
            ...
            g.fillOval((int) (400+myCat.getPosition().getMyRadius() * Math
                    .cos(myCat.getPosition().getMyAngle())) ,
                    400 + (int) (myCat.getPosition().getMyRadius() * Math
                            .sin(myCat.getPosition().getMyAngle())), 20, 20);
 
            g.setColor(Color.blue); // mouse is blue color
            g.fillOval(400 + (int) (100 * Math.cos(myMouse.getPosition()
                    .getMyAngle())), 400 + (int) (100 * Math.sin(myMouse
            ...
            g.drawLine((int) (myCat.getPosition().getMyRadius() * Math
                    ...
                    400 + (int) (100 * Math.cos(myMouse.getPosition()
                            .getMyAngle())), 400 + (int) (100 * Math
